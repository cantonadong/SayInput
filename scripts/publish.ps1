param([string]$SdkPath = 'D:/Program/dotnet', [string]$Output = 'artifacts/SayInput-1.1.0-win-x64')
...
Write-Host "Runnable application: $Output/SayInput.exe (keep the entire folder)."
